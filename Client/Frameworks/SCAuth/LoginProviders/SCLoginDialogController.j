...
- (void)_loginUser:(CPString)username password:(CPString)password
{
    ...
    var loginObject = {'user' : {'username' : username, 'password' : password, 'remember' : shouldRemember}};
...
{
    var shouldRemember = ([_rememberMeButton state] === CPOnState);
    var registerObject = {'user' : {'username' : username, 'password' : password, 'remember' : shouldRemember}};
